---
title: "Most harmful weather events across the USA 2001-2011"
author: "Heli Pykälä"
date: "2016-05-04"
...
Data was downloaded from https://d396qusza40orc.cloudfront.net/repdata/data/StormData.csv.bz2 on 2016-04-28.
...
```{r head2}
head(storm[order(CDMG,decreasing = TRUE),
           c("REFNUM","BGN_DATE", "STATE", "EVTYPE","CROPDMG","CROPDMGEXP", "CDMG"),with=FALSE])
head(storm[order(INJURIES,decreasing = TRUE),
           c("REFNUM","BGN_DATE", "STATE", "EVTYPE","INJURIES","FATALITIES"),with=FALSE])
head(storm[order(FATALITIES,decreasing = TRUE),
           c("REFNUM","BGN_DATE", "STATE", "EVTYPE","INJURIES","FATALITIES"),with=FALSE])
